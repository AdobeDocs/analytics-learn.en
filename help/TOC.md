...
+ Implementation {#implementation}
  ...
  + Via Experience Platform Launch {#via-adobe-launch}
    ...
    + [Using a Data Layer to set Page Name and Other Variables via Experience Platform Launch](implementation/via-adobe-launch/using-a-data-layer-to-set-page-name-and-other-variables-via-launch.md)
