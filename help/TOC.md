...
+ Administration {#administration}
  ...
  + Manage Report Suites {#manage-report-suites}
    ...
    + [Set up marketing channels](administration/marketing-channels/set-up-marketing-channels.md)
    + [Create marketing channel processing rules](administration/marketing-channels/create-marketing-channel-processing-rules.md)
