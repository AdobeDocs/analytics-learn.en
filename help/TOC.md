...
+ Analysis Workspace {#analysis-workspace}
  ...
  + Building Freeform Tables {#building-freeform-tables}
    ...
    + [Using the left rail to build freeform tables](analysis-workspace/building-freeform-tables/using-the-left-rail-to-build-freeform-tables-in-analysis-workspace.md)
    ...
    + [Reordering static rows](analysis-workspace/building-freeform-tables/reordering-static-rows-in-analysis-workspace.md)
