...
For many actions on the page, tracking should not be treated like a page view. In this video, you will learn how to code a link tracking beacon to Analytics, if you are not using a tag manager (like Adobe [!DNL Launch]). See the code, as well as learning an important tip.
...
**Note:** As stated in the title of this page, in this video we are showing you how to code a custom link hit when you are NOT using a tag manager, like Adobe [!DNL Launch]. We still do recommend that you use Adobe [!DNL Launch], our best practice recommendation for implementation. However, if you are not using Adobe [!DNL Launch] and need to code in an s.tl(), here’s how to do it.
